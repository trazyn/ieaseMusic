...
#### Mac(10.9+)
[Download](https://github.com/trazyn/ieaseMusic/releases/download/v1.0.4/ieaseMusic-1.0.4-mac.dmg) the `.dmg` file, Or use `homebrew`:
```
...
[Download](https://github.com/trazyn/ieaseMusic/releases/download/v1.0.4/ieaseMusic-1.0.4-linux-amd64.deb) the `.deb` file for 'Debian / Ubuntu':
```
$ sudo dpkg -i ieaseMusic-0.0.5-linux-amd64.deb
```

[Download](https://github.com/trazyn/ieaseMusic/releases/download/v1.0.4/ieaseMusic-1.0.4-linux-x86_64.rpm) the `.rpm` file for 'Centos/RHEL':
```
$ sudo yum localinstall ieaseMusic-0.0.5-linux-x86_64.rpm
```

[Download](https://github.com/trazyn/ieaseMusic/releases/download/v1.0.4/iease-music-1.0.4-x86_64.AppImage) the `.Appimage` file for other distribution:
```
