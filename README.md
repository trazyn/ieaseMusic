...
#### Mac(10.9+)
[Download](https://github.com/trazyn/ieaseMusic/releases/download/v1.2.3/ieaseMusic-1.2.3-mac.dmg) the `.dmg` file, Or use `homebrew`:
```
...
[Download](https://github.com/trazyn/ieaseMusic/releases/download/v1.2.3/ieaseMusic-1.2.3-linux-amd64.deb) the `.deb` file for 'Debian / Ubuntu':
```
$ sudo dpkg -i ieaseMusic-1.2.3-linux-amd64.deb
```

[Download](https://github.com/trazyn/ieaseMusic/releases/download/v1.2.3/ieaseMusic-1.2.3-linux-x86_64.rpm) the `.rpm` file for 'Centos/RHEL':
```
$ sudo yum localinstall ieaseMusic-1.2.3-linux-x86_64.rpm
```

[Download](https://github.com/trazyn/ieaseMusic/releases/download/v1.2.3/iease-music-1.2.3-x86_64.AppImage) the `.Appimage` file for other distribution:
```
$ chmod u+x iease-music-1.2.3-x86_64.AppImage
$ ./iease-music-1.2.3-x86_64.AppImage
```
